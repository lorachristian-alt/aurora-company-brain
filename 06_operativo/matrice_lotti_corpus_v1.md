...
| T89 | **L'estrattore congelato del corpus non vede le formule dei fogli di calcolo**: del foglio delle acque reflue restituisce le etichette e il valore d'errore `#DIV/0!`, ma **non le due `AVERAGE`** che stanno nelle celle accanto. Le formule si leggono solo aprendo il file come archivio | **lotto 2B** — emersa dalla revisione col canone e confermata dal ri-giudizio, che sul testo estratto **non poteva vedere** ciò che la nota citava | **nessun lotto**: è una proprietà dello strumento, non di un documento | tracciata — ⚠️ **Non è un difetto di una nota: è un punto cieco della catena di provenienza.** Tutta la QA e tutto lo strato di giudizio girano su quel testo estratto, quindi **un fatto che vive in una formula è invisibile a entrambi**. La nota `fatto-medie-non-calcolate-file-reflue` dichiara il percorso di lettura invece di tacerlo. ⚠️ **Da portare al gate finale**: l'archivio ha altri fogli di calcolo, e nessuno sa quante sintesi vivano in celle che il progetto non legge |
