...
*Escluse `workspace\` e `sources\` dai conteggi di qualità: **208** note.*
...
---
## qa_frontmatter (perimetro: lotto, 55 note)
...
## qa_link_integrity (perimetro: lotto, 217 note nel vault)
...
## qa_provenance (perimetro: lotto, 55 note)
...
## qa_copertura (perimetro: lotto, 55 note)
