...
> suite QA · perimetro lotto · **0 ERRORI, 45 AVVISI** · esito **GIALLO**
...
| `fatto-il-titolare-promette-i-lavori-alla-chiusura-estiva.md` |  | frontmatter | summary di 275 caratteri (tetto 250) |
...
## qa_link_integrity (perimetro: lotto, 506 note nel vault)
...
| `questione-la-stima-e-il-preventivo.md` | conflitto | aperto | 2 |
