...
> suite QA · perimetro vault · **106 ERRORI, 444 AVVISI** · esito **ROSSO**
...
---
## qa_frontmatter (perimetro: vault, 507 note)
...
| `fatto-abort-cip-per-soda-bassa.md` |  | frontmatter | dichiara un'assenza con la formula di E3 ma non rimanda a un artefatto di ricerca in 06_operativo\ricerche_assenza\ (E43) — debito anteriore a E43, da sanare a fine corsa |
...
| `fatto-allarme-acustico-md-3200-basso.md` |  | frontmatter | dichiara un'assenza con la formula di E3 ma non rimanda a un artefatto di ricerca in 06_operativo\ricerche_assenza\ (E43) — debito anteriore a E43, da sanare a fine corsa |
...
| `fatto-certificato-analisi-gas-alimentari.md` |  | frontmatter | dichiara un'assenza con la formula di E3 ma non rimanda a un artefatto di ricerca in 06_operativo\ricerche_assenza\ (E43) — debito anteriore a E43, da sanare a fine corsa |
| `fatto-cicli-cip-chiusi-con-sonda-guasta.md` |  | frontmatter | corpo di 343 parole: fra 301 e 350, si motiva o si spezza |
| `fatto-cicli-cip-chiusi-con-sonda-guasta.md` |  | frontmatter | dichiara un'assenza con la formula di E3 ma non rimanda a un artefatto di ricerca in 06_operativo\ricerche_assenza\ (E43) — debito anteriore a E43, da sanare a fine corsa |
| `fatto-cicli-cip-maggio.md` |  | frontmatter | corpo di 344 parole: fra 301 e 350, si motiva o si spezza |
...
| `fatto-confezioni-vendute-rincorse-dalla-qualita.md` |  | frontmatter | summary di 270 caratteri (tetto 250) |
| `fatto-contatori-reparto-meta-stabilimento.md` |  | frontmatter | dichiara un'assenza con la formula di E3 ma non rimanda a un artefatto di ricerca in 06_operativo\ricerche_assenza\ (E43) — debito anteriore a E43, da sanare a fine corsa |
...
| `fatto-e410-non-in-nessuna-ricetta-attiva.md` |  | frontmatter | summary di 251 caratteri (tetto 250) |
| `fatto-energia-reattiva-oltre-soglia.md` |  | frontmatter | dichiara un'assenza con la formula di E3 ma non rimanda a un artefatto di ricerca in 06_operativo\ricerche_assenza\ (E43) — debito anteriore a E43, da sanare a fine corsa |
| `fatto-esempio-cinque-perche-e-il-caso-del-12-05.md` |  | frontmatter | summary di 266 caratteri (tetto 250) |
| `fatto-evidenze-audit-oltre-termine.md` |  | frontmatter | corpo di 348 parole: fra 301 e 350, si motiva o si spezza |
| `fatto-evidenze-nc1-partite-il-02-04.md` |  | frontmatter | summary di 259 caratteri (tetto 250) |
...
| `fatto-forni-in-temperatura-durante-fermo-10-05.md` |  | frontmatter | dichiara un'assenza con la formula di E3 ma non rimanda a un artefatto di ricerca in 06_operativo\ricerche_assenza\ (E43) — debito anteriore a E43, da sanare a fine corsa |
...
| `fatto-il-perimetro-si-apre-al-riavvio-delle-18-45.md` |  | frontmatter | summary di 256 caratteri (tetto 250) |
| `fatto-il-perimetro-si-apre-al-riavvio-delle-18-45.md` |  | frontmatter | corpo di 330 parole: fra 301 e 350, si motiva o si spezza |
...
| `fatto-mock-recall-07-11-2025.md` |  | frontmatter | summary di 276 caratteri (tetto 250) |
...
| `fatto-secondo-reclamo-rec-2026-012.md` |  | frontmatter | summary di 279 caratteri (tetto 250) |
| `fatto-secondo-reclamo-rec-2026-012.md` |  | frontmatter | corpo di 313 parole: fra 301 e 350, si motiva o si spezza |
| `fatto-segnalazione-dal-form-12-05.md` |  | frontmatter | corpo di 336 parole: fra 301 e 350, si motiva o si spezza |
| `fatto-semilavorato-vaniglia-segregato.md` |  | frontmatter | summary di 275 caratteri (tetto 250) |
...
| `questione-verifiche-ccp3-10-05-tre-versioni.md` |  | frontmatter | dichiara un'assenza con la formula di E3 ma non rimanda a un artefatto di ricerca in 06_operativo\ricerche_assenza\ (E43) — debito anteriore a E43, da sanare a fine corsa |
| `fatto-blocco-cautelativo-lotti.md` |  | frontmatter | corpo di 335 parole: fra 301 e 350, si motiva o si spezza |
| `fatto-due-nc-di-febbraio-materializzate.md` |  | frontmatter | summary di 294 caratteri (tetto 250) |
| `fatto-estensione-ai-lotti-successivi-nc-2026-097.md` |  | frontmatter | summary di 257 caratteri (tetto 250) |
...
| `doc-bozza-comunicazione-al-cliente.md` |  | frontmatter | summary contiene piu' di una frase |
...
| `doc-classi-reclamo.md` |  | frontmatter | corpo di 322 parole: fra 301 e 350, si motiva o si spezza |
| `doc-comunicazione-ai-clienti-nella-crisi.md` |  | frontmatter | summary di 278 caratteri (tetto 250) |
...
| `doc-gestione-del-prodotto-reso.md` |  | frontmatter | summary di 290 caratteri (tetto 250) |
| `doc-indicatori-reclami.md` |  | frontmatter | summary di 271 caratteri (tetto 250) |
| `doc-io-05-lavaggio-cip.md` |  | frontmatter | corpo di 343 parole: fra 301 e 350, si motiva o si spezza |
| `doc-mock-recall-annuale.md` |  | frontmatter | summary di 255 caratteri (tetto 250) |
...
| `doc-pro-qa-08.md` |  | frontmatter | corpo di 330 parole: fra 301 e 350, si motiva o si spezza |
...
| `questione-classe-del-reclamo-rec-2026-011.md` |  | frontmatter | summary di 303 caratteri (tetto 250) |
| `questione-classe-del-reclamo-rec-2026-011.md` |  | frontmatter | summary contiene piu' di una frase |
...
| `questione-il-ritiro-non-notifica-all-ente.md` |  | frontmatter | summary di 272 caratteri (tetto 250) |
...
| `questione-prefisso-dello-studio-della-consulente.md` |  | frontmatter | summary di 262 caratteri (tetto 250) |
| `questione-pro-qa-08-reclami-o-rintracciabilita.md` |  | frontmatter | summary di 264 caratteri (tetto 250) |
...
| `script-cerca-assenza.md` |  | frontmatter | corpo di 317 parole: fra 301 e 350, si motiva o si spezza |
...
| `bozza-contratto-manutenzione-frigo.md` |  | frontmatter | dichiara un'assenza con la formula di E3 ma non rimanda a un artefatto di ricerca in 06_operativo\ricerche_assenza\ (E43) — debito anteriore a E43, da sanare a fine corsa |
| `sessione-s4-lotto-02a.md` |  | frontmatter | summary di 264 caratteri (tetto 250) |
| `sessione-s4-lotto-02b.md` |  | frontmatter | summary di 269 caratteri (tetto 250) |
| `sessione-s4-lotto-03b.md` |  | frontmatter | summary di 258 caratteri (tetto 250) |
| `sessione-s4-lotto-03e.md` |  | frontmatter | summary di 252 caratteri (tetto 250) |


## qa_link_integrity (perimetro: vault, 507 note nel vault)
...
| `fatto-estensione-ai-lotti-successivi-nc-2026-097.md` |  | link | lontana dall'_index della propria cartella (3 salti): indizio di cattiva collocazione |
| `fatto-l26129-fuori-dal-perimetro.md` |  | link | lontana dall'_index della propria cartella (3 salti): indizio di cattiva collocazione |
| `fatto-perimetro-del-blocco-dal-riavvio.md` |  | link | lontana dall'_index della propria cartella (3 salti): indizio di cattiva collocazione |
...
| `fatto-team-di-crisi-convocato-15-05.md` |  | link | lontana dall'_index della propria cartella (4 salti): indizio di cattiva collocazione |
| `doc-avviso-al-consumatore-e-portavoce.md` |  | link | lontana dall'_index della propria cartella (4 salti): indizio di cattiva collocazione |
| `doc-bozza-comunicazione-al-cliente.md` |  | link | lontana dall'_index della propria cartella (3 salti): indizio di cattiva collocazione |
...
| `doc-comunicazione-ai-clienti-nella-crisi.md` |  | link | lontana dall'_index della propria cartella (3 salti): indizio di cattiva collocazione |
...
| `doc-gestione-del-prodotto-reso.md` |  | link | lontana dall'_index della propria cartella (3 salti): indizio di cattiva collocazione |
| `doc-mass-balance-nella-crisi.md` |  | link | lontana dall'_index della propria cartella (3 salti): indizio di cattiva collocazione |
| `doc-mock-recall-annuale.md` |  | link | lontana dall'_index della propria cartella (3 salti): indizio di cattiva collocazione |
...
| `doc-notifica-all-autorita.md` |  | link | lontana dall'_index della propria cartella (3 salti): indizio di cattiva collocazione |
| `doc-pro-qa-14.md` |  | link | lontana dall'_index della propria cartella (3 salti): indizio di cattiva collocazione |
...
| `doc-team-di-crisi.md` |  | link | lontana dall'_index della propria cartella (3 salti): indizio di cattiva collocazione |
| `doc-tempistiche-vincolanti-della-crisi.md` |  | link | lontana dall'_index della propria cartella (3 salti): indizio di cattiva collocazione |
| `concetto-ritiro-e-richiamo.md` |  | link | lontana dall'_index della propria cartella (3 salti): indizio di cattiva collocazione |
| `questione-due-esercitazioni-e-una-sola-ultima.md` |  | link | lontana dall'_index della propria cartella (3 salti): indizio di cattiva collocazione |
| `questione-il-ritiro-non-notifica-all-ente.md` |  | link | lontana dall'_index della propria cartella (3 salti): indizio di cattiva collocazione |
| `questione-perimetro-del-blocco-e-mass-balance.md` |  | link | lontana dall'_index della propria cartella (3 salti): indizio di cattiva collocazione |
| `questione-prefisso-dello-studio-della-consulente.md` |  | link | lontana dall'_index della propria cartella (3 salti): indizio di cattiva collocazione |
...
## qa_provenance (perimetro: vault, 507 note)
...
| `fatto-allerta-registrata-come-non-applicabile.md` |  | provenance | la fonte 'Fwd_Fwd_Fwd_ATTENZIONE_richiamo_prodotto_concorrente_RASFF.eml' non aggancia nessuna affermazione della nota: rumore nel payload |
...
| `fatto-classe-1-sempre-alla-direzione.md` |  | provenance | la fonte 'PRO-QA-08_gestione_reclami_cliente_rev2.docx' non aggancia nessuna affermazione della nota: rumore nel payload |
...
| `fatto-semilavorato-vaniglia-segregato.md` |  | provenance | la fonte 'Fwd_Fwd_Fwd_ATTENZIONE_richiamo_prodotto_concorrente_RASFF.eml' non aggancia nessuna affermazione della nota: rumore nel payload |
...
| `questione-classe-del-reclamo-rec-2026-011.md` |  | provenance | la fonte 'cruscotto_KPI_qualita_2026.xlsx' non aggancia nessuna affermazione della nota: rumore nel payload |
...
## qa_copertura (perimetro: vault, 507 note)
...
| `fatto-costo-stimato-del-ritiro-31500.md` | atomica | risolto | 1 |
...
| `doc-bozza-comunicazione-al-cliente.md` | atomica | risolto | 1 |
| `doc-comunicazione-ai-clienti-nella-crisi.md` | atomica | risolto | 1 |
...
| `doc-avviso-al-consumatore-e-portavoce.md` | atomica | risolto | 1 |
...
| `fatto-team-di-crisi-convocato-15-05.md` | atomica | risolto | 1 |
...
| `doc-gestione-del-prodotto-reso.md` | atomica | risolto | 1 |
...
| `fatto-il-perimetro-si-apre-al-riavvio-delle-18-45.md` | atomica | risolto | 2 |
...
| `sessione-s4-lotto-1b.md` | sessione | — | 0 |
...
| `doc-pro-qa-14.md` | atomica | risolto | 1 |
...
| `doc-sds-detergente-acido-cip.md` | atomica | risolto | 2 |
| `doc-seconda-firma-indagine.md` | atomica | risolto | 1 |
| `doc-sequenze-produzione-allergeni.md` | atomica | risolto | 1 |
| `doc-team-di-crisi.md` | atomica | risolto | 1 |
| `doc-tempistiche-vincolanti-della-crisi.md` | atomica | risolto | 1 |
...
| `fatto-confezioni-vendute-rincorse-dalla-qualita.md` | atomica | aperto | 1 |
...
| `fatto-due-nc-di-febbraio-materializzate.md` | atomica | risolto | 1 |
...
| `fatto-estensione-ai-lotti-successivi-nc-2026-097.md` | atomica | risolto | 1 |
...
| `fatto-il-turno-3-non-e-nel-mass-balance.md` | atomica | aperto | 2 |
...
| `fatto-l26129-fuori-dal-perimetro.md` | atomica | risolto | 1 |
...
| `fatto-lo-spedito-eccede-il-sotto-lotto.md` | atomica | aperto | 1 |
...
| `fatto-mock-recall-07-11-2025.md` | atomica | risolto | 1 |
...
| `fatto-perimetro-del-blocco-dal-riavvio.md` | atomica | risolto | 1 |
...
| `fatto-secondo-reclamo-rec-2026-012.md` | atomica | risolto | 2 |
| `fatto-segnalazione-dal-form-12-05.md` | atomica | risolto | 3 |
...
| `questione-classe-del-reclamo-rec-2026-011.md` | conflitto | aperto | 5 |
...
| `questione-due-codici-per-la-procedura-di-ritiro.md` | conflitto | aperto | 3 |
| `questione-due-esercitazioni-e-una-sola-ultima.md` | conflitto | aperto | 2 |
...
| `questione-il-ritiro-non-notifica-all-ente.md` | conflitto | aperto | 2 |
...
| `questione-mock-recall-due-ore-o-quattro.md` | conflitto | aperto | 4 |
| `questione-nc-interne-registrate-su-mod-qa-31.md` | conflitto | aperto | 6 |
| `questione-nc-lavaggi-sul-modulo-reclami.md` | conflitto | aperto | 6 |
| `questione-ora-di-arrivo-della-segnalazione.md` | conflitto | aperto | 5 |
| `questione-ore-formazione-due-valori-per-il-2025.md` | conflitto | aperto | 2 |
| `questione-perimetro-del-blocco-e-mass-balance.md` | conflitto | aperto | 2 |
...
| `questione-prefisso-dello-studio-della-consulente.md` | conflitto | aperto | 3 |
| `questione-pro-qa-08-reclami-o-rintracciabilita.md` | conflitto | aperto | 4 |
...
| `questione-tre-sigle-per-le-procedure-di-qualita.md` | conflitto | aperto | 3 |
...
| `questione-una-revisione-che-registra-fatti-posteriori.md` | atomica | aperto | 1 |
...
| `script-misura-due-tassi.md` | atomica | risolto | 0 |
...
| `sessione-s4-lotto-02a.md` | sessione | — | 0 |
| `sessione-s4-lotto-02b.md` | sessione | — | 0 |
| `sessione-s4-lotto-02b-bis.md` | sessione | — | 0 |
| `sessione-s4-lotto-03a.md` | sessione | — | 0 |
| `sessione-s4-lotto-03b.md` | sessione | — | 0 |
| `sessione-s4-lotto-03c.md` | sessione | — | 0 |
| `sessione-s4-lotto-03d.md` | sessione | — | 0 |
| `sessione-s4-lotto-03e.md` | sessione | — | 0 |
| `sessione-s4-lotto-03f.md` | sessione | — | 0 |
...
| `Fwd_Fwd_Fwd_ATTENZIONE_richiamo_prodotto_concorrente_RASFF.eml` | fatto-allerta-rasff-2026-1467, fatto-allerta-registrata-come-non-applicabile, fatto-e410-non-in-nessuna-ricetta-attiva, fatto-semilavorato-vaniglia-segregato, entita-federalimentare-veneto, questione-richiesta-auditor-sulle-allerte, questione-riesame-trimestrale-haccp |
...
| `IO-05_istruzione_operativa_lavaggio_CIP.docx` | fatto-abilitazione-obbligatoria-cip, fatto-abort-cip-per-soda-bassa, fatto-cicli-cip-chiusi-con-sonda-guasta, fatto-cicli-cip-maggio, fatto-cip-fuori-criterio, fatto-criterio-conducibilita-cip-superato, fatto-io-05-affissa-in-revisione-superata, fatto-nc-cip-2026, fatto-programma-p2-ogni-giorno, fatto-sds-revisione-in-linea-superata, fatto-taniche-e-rifiuti-cip, questione-composizione-lavaggio-completo, questione-dpi-cip-due-prescrizioni, questione-frequenza-tamponi-prescritta-e-reale, questione-frequenza-verifica-lavaocchi-cip, questione-prodotto-acido-cip-an-15-o-acidfood-25, doc-ciclo-cip-interrotto, doc-criteri-accettazione-cip, doc-dpi-lavaggio-cip, doc-io-05-lavaggio-cip, doc-parametri-fasi-cip, doc-programmi-cip-per-linea, doc-registrazioni-cip, doc-sds-detergente-acido-cip, entita-chemifood-italia, macchina-cip-01, concetto-cip, kpi-conducibilita-risciacquo-cip-maggio, kpi-durate-fasi-cip-maggio, kpi-portata-cip-maggio, kpi-temperature-cip-maggio |
...
| `MOD-QA-31_reclamo_REC-2026-011.pdf` | fatto-avvertenza-costruttore-guarnizioni-non-originali, fatto-verifiche-ccp3-turno-l26130, questione-nc-interne-registrate-su-mod-qa-31, questione-nc-lavaggi-sul-modulo-reclami, fatto-blocco-cautelativo-lotti, fatto-misura-frammento-rec-2026-011, progetto-gestione-reclamo-rec-2026-011, questione-data-apertura-rec-2026-011, entita-elena-marchetti, prodotto-af-sn-0450, questione-classe-del-reclamo-rec-2026-011, questione-ora-di-arrivo-della-segnalazione |
...
| `PRO-QA-08_gestione_reclami_cliente_rev2.docx` | fatto-classe-1-sempre-alla-direzione, fatto-confezioni-vendute-rincorse-dalla-qualita, fatto-due-segnalazioni-rendono-il-ritiro-non-rimandabile, fatto-esempio-cinque-perche-e-il-caso-del-12-05, fatto-evidenze-nc1-partite-il-02-04, fatto-fantin-approva-le-azioni-correttive, fatto-form-sito-senza-lotto-obbligatorio, fatto-laboratorio-interno-escluso-dalle-analisi, fatto-nessuno-risponde-a-voce-al-consumatore, fatto-pro-qa-08-copia-di-lavoro, fatto-quattro-clienti-gdo-nominati-dalla-procedura, fatto-reclami-fornitori-tolti-da-pro-qa-08, fatto-risposta-alla-consumatrice-13-05, fatto-secondo-reclamo-rec-2026-012, fatto-segnalazione-dal-form-12-05, questione-clausola-della-nc1-in-due-versioni, questione-nc-interne-registrate-su-mod-qa-31, questione-nc-lavaggi-sul-modulo-reclami, doc-campione-reso, doc-causa-radice-reclami, doc-chiusura-di-un-reclamo, doc-classi-reclamo, doc-comunicazione-consumatore, doc-comunicazione-reclamo-cliente, doc-conservazione-reclami, doc-indicatori-reclami, doc-pro-qa-08, doc-protocollo-reclami, doc-responsabilita-reclami, doc-riferimenti-pro-qa-08, doc-seconda-firma-indagine, doc-verifiche-immediate-reclamo, questione-classe-del-reclamo-rec-2026-011, questione-due-codici-per-la-procedura-di-ritiro, questione-ora-di-arrivo-della-segnalazione, questione-prefisso-dello-studio-della-consulente, questione-pro-qa-08-reclami-o-rintracciabilita, questione-reclami-per-confezioni-o-per-pezzi, questione-tre-sigle-per-le-procedure-di-qualita |
| `Prospetto_straordinari_gen-apr_2026.xlsx` | **nessuna** |
| `RE_RE_URGENTE_reclamo_corpo_estraneo_lotto_L26130.eml` | fatto-ccp3-non-in-causa-sul-frammento, fatto-segnalazione-dal-form-12-05, fatto-blocco-cautelativo-lotti, progetto-gestione-reclamo-rec-2026-011, questione-data-apertura-rec-2026-011, questione-misura-frammento-strumentale, entita-elena-marchetti, questione-classe-del-reclamo-rec-2026-011, questione-ora-di-arrivo-della-segnalazione |
...
| `Rilievo_Audit_BRC_IFS_CSQA_febbraio2026.txt` | self-certificazioni, area-qualita, fatto-audit-csqa-febbraio-2026-esito, fatto-chi-e-stato-intervistato-in-audit, fatto-chiusura-nc-documentale-e-il-richiamo, fatto-due-nc-e-cinque-osservazioni, fatto-due-nc-minori-audit-2026, fatto-evidenze-audit-oltre-termine, fatto-grade-aa-messo-in-guardia, fatto-il-carrello-ricambi-ancora-a-bordo-linea-il-25-maggio, fatto-impianto-haccp-verificato-in-audit, fatto-nc1-seconde-firme-undici-moduli-su-venti, fatto-nc2-carrello-ricambi-a-bordo-linea, fatto-quattro-neoassunti-linea2-senza-formazione-allergeni, fatto-rapporto-di-verifica-md-3200-solo-via-mail, fatto-rivalidazione-ccp2-non-formalizzata, fatto-scope-certificato-e-quattro-esclusioni, fatto-semilavorati-senza-identificazione-in-cella, fatto-sistema-adeguato-con-riserve, fatto-sopralluogo-interno-del-27-maggio-quattro-punti-critici, fatto-termometri-tp08-tp11-fuori-dal-registro, fatto-test-rintracciabilita-audit-2h50, fatto-vendor-rating-senza-imballaggi-e-laboratorio, fatto-zanzariera-lacerata-e-porta-officina, questione-carrello-ricambi-dichiarato-rimosso, questione-categorie-e-durata-audit-divergenti, questione-clausola-della-nc1-in-due-versioni, questione-convalida-md-3200-tre-date, questione-data-di-emissione-del-rapporto-di-audit, questione-evidenze-del-02-04-nove-o-cinque, questione-proroga-informale-al-27-03, questione-quando-l-ente-torna-a-verificare, questione-sette-nc-o-due, questione-tre-o-quattro-neoassunti-senza-formazione, questione-validazione-ccp2-mai-confermata, questione-vendor-rating-2025-c-e-o-non-c-e, doc-rapporto-audit-csqa-2026, entita-csqa-certificazioni, entita-nadia-franceschini, questione-richiesta-auditor-sulle-allerte |
...
| `Scheda_tecnica_prodotto_AF-SN-0450_rev4.pdf` | fatto-fornitura-gas-nordgas-06-05, fatto-verifica-metrologia-legale-bilance, questione-posizione-md-3200-in-linea, questione-precauzionale-af-sn-0450-soia, doc-limite-o2-residuo-af-sn-0450, doc-mod-qa-07, doc-scheda-tecnica-af-sn-0450, macchina-ft-01, macchina-linea-1, macchina-md-3200, prodotto-af-sn-0450, concetto-atmosfera-protettiva, concetto-ccp, concetto-shelf-life, kpi-shelf-life-af-sn-0450, questione-aw-umidita-af-sn-0450, questione-limite-o2-residuo |
| `Verbale_ispezione_ATS_09_06_2026.pdf` | fatto-armadietto-spogliatoi-rotto-da-marzo, fatto-due-dei-tre-rilievi-e-il-sopralluogo-interno, fatto-il-controllo-copre-sei-dei-dodici-capitoli-annunciati, fatto-il-nesso-col-reclamo-escluso-dalla-qualita, fatto-il-titolare-promette-i-lavori-alla-chiusura-estiva, fatto-impianto-haccp-verificato-in-audit, fatto-ispezione-ats-carrello-ricambi, fatto-la-documentazione-visionata-non-copre-l-elenco-richiesto, fatto-planimetria-esche-senza-le-tre-postazioni-di-via-palu, fatto-strumenti-taratura-scaduta-in-uso, questione-carrello-ricambi-dichiarato-rimosso, questione-due-attestati-mancanti-o-due-assenti-al-corso, questione-due-protocolli-per-lo-stesso-preavviso, questione-i-moduli-ccp-rivisti-prima-del-controllo, questione-il-legale-rappresentante-arriva-a-sopralluogo-iniziato, questione-la-stima-e-il-preventivo, questione-posizione-md-3200-in-linea, questione-taratura-termoregistratore-cf-02, progetto-controllo-ufficiale-ats-2026, doc-manuale-haccp, doc-obblighi-dell-osa-durante-il-controllo, doc-sanzioni-prospettate-dal-preavviso, entita-elena-marchetti, entita-paola-segattini, entita-ulss-9-scaligera, kpi-controllo-interno-acqua-il-giorno-dell-ispezione |
...
| `log_lavaggio_CIP_linea1_maggio.log` | fatto-abort-cip-per-soda-bassa, fatto-cicli-cip-chiusi-con-sonda-guasta, fatto-cicli-cip-maggio, fatto-ciclo-cip-straordinario-11-05, fatto-cip-fuori-criterio, fatto-criterio-conducibilita-cip-superato, fatto-nc-cip-2026, fatto-programma-p2-ogni-giorno, questione-composizione-lavaggio-completo, macchina-cip-01, kpi-conducibilita-risciacquo-cip-maggio, kpi-consumi-energia-maggio-2026, kpi-durate-fasi-cip-maggio, kpi-portata-cip-maggio, kpi-produzione-0450-linea1-maggio, kpi-temperature-cip-maggio |
...
| `manuale_HACCP_Aurora_v4_2024_ESTRATTO_REALE.txt` | area-qualita, area-risorse-umane, fatto-abilitazione-obbligatoria-cip, fatto-accettazione-con-riserva-gas-06-05, fatto-allarme-acustico-md-3200-basso, fatto-allarmi-alta-temperatura-cf-02-aprile, fatto-ccp3-non-in-causa-sul-frammento, fatto-certificato-analisi-gas-alimentari, fatto-convalida-md-1800-scaduta, fatto-datalogger-dl-001-in-taratura, fatto-decisione-proseguire-valvola-08-05, fatto-deviazione-ccp2-l26130, fatto-due-registri-paralleli-della-metrologia, fatto-fermo-forno-ft-01-05-05, fatto-giro-di-vite-seconde-firme-ccp3, fatto-impianto-haccp-verificato-in-audit, fatto-io-05-affissa-in-revisione-superata, fatto-microperdite-saldatura-l26130, fatto-modulo-nc-acqua-riconciliato, fatto-nc1-seconde-firme-undici-moduli-su-venti, fatto-nc2-carrello-ricambi-a-bordo-linea, fatto-nessuna-nc-per-allarmi-cf-02, fatto-operatore-senza-formazione-haccp-l26130, fatto-operatori-ccp3-linea1-maggio, fatto-planimetria-esche-senza-le-tre-postazioni-di-via-palu, fatto-pre-verifica-simulata-prima-del-controllo, fatto-prodotto-non-segregato-deviazione-ccp2, fatto-quattro-neoassunti-linea2-senza-formazione-allergeni, fatto-registro-cartaceo-mod-qa-12, fatto-riepilogo-datalogger-inaffidabile, fatto-risalita-termica-post-riavvio-l26130, fatto-rivalidazione-ccp2-non-formalizzata, fatto-sonde-pt-104-in-taratura, fatto-strumenti-cf-02-e-ccp4, fatto-strumenti-esclusi-da-taratura, fatto-strumenti-taratura-scaduta-in-uso, fatto-tassello-aisi-clip-rotta, fatto-termometri-tp08-tp11-fuori-dal-registro, fatto-test-rintracciabilita-audit-2h50, fatto-validita-haccp-da-procedura-non-in-archivio, fatto-valvola-modulante-pt-104-revisione-rimandata, fatto-vendor-rating-senza-imballaggi-e-laboratorio, fatto-verifiche-ccp3-turno-l26130, fatto-zanzariera-lacerata-e-porta-officina, questione-carrello-ricambi-dichiarato-rimosso, questione-clausola-della-nc1-in-due-versioni, questione-convalida-md-1800-scaduta-o-valida, questione-convalida-md-3200-due-registri, questione-convalida-md-3200-tre-date, questione-due-registri-tarature-pt-104, questione-durata-deviazione-ccp2-l26130, questione-i-moduli-ccp-rivisti-prima-del-controllo, questione-mock-recall-due-ore-o-quattro, questione-nc-lavaggi-sul-modulo-reclami, questione-periodicita-taratura-canali-datalogger-ccp2, questione-posizione-md-3200-in-linea, questione-proteine-test-manuale-e-scheda, questione-sigla-kit-tasselli-ccp3, questione-taratura-termoregistratore-cf-02, questione-tassello-inox-non-passato, questione-tmc-farina-mv26-0429a, questione-ultima-potabilita-completa-2023-o-2026, questione-validazione-ccp2-mai-confermata, questione-verifiche-ccp3-10-05-tre-versioni, fatto-blocco-cautelativo-lotti, fatto-misura-frammento-rec-2026-011, fatto-richiesta-relazione-48-ore, questione-data-apertura-rec-2026-011, doc-ccp2-limite-critico, doc-ccp4-limite-critico, doc-gestione-deviazioni-haccp, doc-gestione-reclami-haccp, doc-manuale-haccp, doc-mod-qa-07, doc-piano-autocontrollo-acqua, doc-piano-tamponi-superfici, doc-scadenzario-formazione-2026, doc-verifiche-immediate-reclamo, entita-chemifood-italia, entita-chiara-vicentini, entita-elena-marchetti, entita-ionut-popescu, entita-ivano-dal-maso, entita-nordgas, entita-ulss-9-scaligera, lotto-l26130, lotto-mv26-0429a, macchina-cf-02, macchina-cip-01, macchina-linea-1, macchina-md-3200, macchina-pkm-450, macchina-pt-104, macchina-ts-01, prodotto-af-sn-0450, concetto-ccp, concetto-cip, kpi-mass-balance-l26130, kpi-parco-strumenti-taratura-2026, kpi-seconde-firme-ccp3-maggio, kpi-shelf-life-af-sn-0450, kpi-temperatura-uscita-tunnel-ts-01-aprile, questione-due-codici-per-la-procedura-di-ritiro, questione-prefisso-dello-studio-della-consulente, questione-pro-qa-08-reclami-o-rintracciabilita, questione-riesame-trimestrale-haccp, questione-tre-sigle-per-le-procedure-di-qualita |
...
| `non_conformita_interne_registro_2026.csv` | fatto-accettazione-con-riserva-gas-06-05, fatto-armadietto-spogliatoi-rotto-da-marzo, fatto-decisione-proseguire-valvola-08-05, fatto-deroga-sequenza-l2-cancellata, fatto-deviazione-ccp2-l26130, fatto-doc-del-film-map-in-scadenza-a-giugno, fatto-due-dei-tre-rilievi-e-il-sopralluogo-interno, fatto-due-nc-interne-sul-proprio-ritardo, fatto-evidenze-audit-oltre-termine, fatto-fermo-pkm-450-l26130, fatto-l-ispezione-attesa-dal-13-maggio-per-via-della-consulente, fatto-modulo-nc-acqua-riconciliato, fatto-nc-102-origine-interna, fatto-nc-26-018-ruote-carrelli-febbraio, fatto-nc-26-055-nastro-forno-maggio, fatto-nc-26-056-ganasce-pkm-450-maggio, fatto-nc-cip-2026, fatto-nessuna-nc-per-allarmi-cf-02, fatto-porta-cella-cf-02-aperta-38-minuti, fatto-registro-cartaceo-mod-qa-12, fatto-riparazione-guarnizione-non-originale, fatto-sopralluogo-interno-del-27-maggio-quattro-punti-critici, fatto-strumenti-map-azoto-pkm-450, fatto-ts-01-fine-vita-dismissione, questione-carrello-ricambi-dichiarato-rimosso, questione-clausola-della-nc1-in-due-versioni, questione-due-attestati-mancanti-o-due-assenti-al-corso, questione-durata-deviazione-ccp2-l26130, questione-i-moduli-ccp-rivisti-prima-del-controllo, questione-la-stima-e-il-preventivo, questione-limite-allarme-porta-cf-02, questione-listeria-24-02-non-nel-registro-tamponi, questione-mock-recall-due-ore-o-quattro, questione-nc-067-sbrinamenti-tunnel, questione-nc-interne-registrate-su-mod-qa-31, questione-nc-lavaggi-sul-modulo-reclami, questione-sbrinamenti-fascia-notturna-cf-02, questione-tre-o-quattro-neoassunti-senza-formazione, entita-ivano-dal-maso, entita-nordgas, macchina-cf-01, concetto-fefo, kpi-temperatura-uscita-tunnel-ts-01-aprile, questione-limite-o2-residuo |
...
| `piano_autocontrollo_acqua_potabile_analisi.csv` | fatto-cloro-residuo-ghiaccio-in-calo, fatto-criterio-conducibilita-cip-superato, fatto-durezza-acqua-addolcita-in-deroga, fatto-modulo-nc-acqua-riconciliato, fatto-nc-acq-26-01-ghiaccio-aprile, fatto-nc-acq-26-02-ferro-spogliatoi-aprile, questione-nc-interne-registrate-su-mod-qa-31, questione-nc-lavaggi-sul-modulo-reclami, questione-ultima-potabilita-completa-2023-o-2026, doc-piano-autocontrollo-acqua, entita-analytica-veneta, kpi-conducibilita-acqua-per-punto, kpi-conducibilita-risciacquo-cip-maggio, kpi-controllo-interno-acqua-il-giorno-dell-ispezione |
...
| `procedura_ritiro_prodotto_CRISI_GDO.txt` | fatto-il-perimetro-si-apre-al-riavvio-delle-18-45, fatto-il-turno-3-non-e-nel-mass-balance, fatto-lo-spedito-eccede-il-sotto-lotto, fatto-mock-recall-07-11-2025, fatto-pro-qa-14-copia-controllata-02, questione-mock-recall-due-ore-o-quattro, questione-una-revisione-che-registra-fatti-posteriori, fatto-classe-2-provvisoria-sul-frammento, fatto-costo-stimato-del-ritiro-31500, fatto-due-nc-di-febbraio-materializzate, fatto-estensione-ai-lotti-successivi-nc-2026-097, fatto-l26129-fuori-dal-perimetro, fatto-perimetro-del-blocco-dal-riavvio, fatto-procedura-applicata-al-caso-di-maggio, fatto-promemoria-di-aggiornare-la-procedura, fatto-team-di-crisi-convocato-15-05, doc-avviso-al-consumatore-e-portavoce, doc-bozza-comunicazione-al-cliente, doc-classi-di-gravita-della-crisi, doc-comunicazione-ai-clienti-nella-crisi, doc-flusso-della-crisi-sei-fasi, doc-gestione-del-prodotto-reso, doc-mass-balance-nella-crisi, doc-mock-recall-annuale, doc-modulistica-e-dossier-di-crisi, doc-notifica-all-autorita, doc-pro-qa-14, doc-riesame-post-crisi, doc-riferimenti-pro-qa-14, doc-team-di-crisi, doc-tempistiche-vincolanti-della-crisi, concetto-ritiro-e-richiamo, questione-classe-del-reclamo-rec-2026-011, questione-due-codici-per-la-procedura-di-ritiro, questione-due-esercitazioni-e-una-sola-ultima, questione-il-ritiro-non-notifica-all-ente, questione-perimetro-del-blocco-e-mass-balance, questione-prefisso-dello-studio-della-consulente, questione-pro-qa-08-reclami-o-rintracciabilita, questione-tre-sigle-per-le-procedure-di-qualita, questione-un-richiamo-in-classe-2 |
...
| `registro_tamponi_superfici_listeria_salmonella.csv` | fatto-carica-in-salita-linea-1-aprile, fatto-date-in-quattro-grafie-registro-tamponi, fatto-lettura-mancante-registro-tamponi, fatto-listeria-scarico-pt-104-aprile, fatto-mani-addetto-farcitura-non-conforme, fatto-nc-26-018-ruote-carrelli-febbraio, fatto-nc-26-055-nastro-forno-maggio, fatto-nc-26-056-ganasce-pkm-450-maggio, questione-due-registri-dei-tamponi, questione-frequenza-tamponi-prescritta-e-reale, questione-listeria-24-02-non-nel-registro-tamponi, questione-tamponi-allergeni-non-registrati, doc-piano-tamponi-superfici, entita-analytica-veneta, kpi-tamponi-per-zona-2026, kpi-tamponi-superfici-2026 |
| `reperibilita_gennaio_febbraio_2026.csv` | **nessuna** |
| `report_costi_fissi_OpEx_manutenzioni.txt` | **nessuna** |
| `report_fermo_macchina_confezionatrice_MAP.txt` | area-manutenzione, fatto-azoto-due-vie-serbatoio-e-rampa, fatto-decisione-proseguire-valvola-08-05, fatto-fermo-pkm-450-l26130, fatto-forni-in-temperatura-durante-fermo-10-05, fatto-guarnizione-pkm-450-manutenzione-scaduta, fatto-il-perimetro-si-apre-al-riavvio-delle-18-45, fatto-riparazione-guarnizione-non-originale, questione-arrivo-officina-fermo-pkm-450, questione-carrello-ricambi-dichiarato-rimosso, questione-codice-allarme-pkm-450, questione-codice-ricambio-valvola-pkm-450, questione-materiale-guarnizione-pkm-450, entita-elena-marchetti, entita-ivano-dal-maso, macchina-pkm-450, kpi-oee-l26130-l1-t2, questione-scarti-riavvio-l26130 |
...
| `tracciabilita_lotti_massbalance_L26130.xlsx` | fatto-il-turno-3-non-e-nel-mass-balance, questione-codici-lotto-azoto-06-05, questione-consegna-farina-mv26-0429a, questione-tmc-farina-mv26-0429a, fatto-blocco-cautelativo-lotti, entita-tosano-cerea, lotto-l26130, lotto-mv26-0429a, prodotto-af-sn-0450, kpi-mass-balance-l26130, questione-azoto-quantita-e-livello-06-05, questione-perimetro-del-blocco-e-mass-balance, questione-pezzi-prodotti-l26130, questione-un-richiamo-in-classe-2 |
| `trascrizione_riunione_direzione_12_05_2026.txt` | area-direzione, fatto-deviazione-ccp2-l26130, fatto-l-ispezione-attesa-dal-13-maggio-per-via-della-consulente, fatto-registro-cartaceo-mod-qa-12, fatto-riunione-direzione-reclamo-l26130, questione-data-riunione-direzione, questione-la-stima-e-il-preventivo, questione-materiale-guarnizione-pkm-450, fatto-blocco-cautelativo-lotti, questione-data-apertura-rec-2026-011, entita-ionut-popescu, questione-ora-di-arrivo-della-segnalazione |
...
| `verbale_riesame_direzione_SGQ_2026.txt` | fatto-audit-cliente-tosano-novembre, fatto-audit-csqa-febbraio-2026-esito, fatto-audit-interni-2025-nove-su-dieci, fatto-azioni-riesame-2025-non-tutte-chiuse, fatto-ccp-stato-al-riesame-2026, fatto-costo-non-qualita-2025-parziale, fatto-decisione-erp-rimandata, fatto-digitalizzazione-archivio-rinviata, fatto-due-nc-minori-audit-2026, fatto-evidenze-audit-oltre-termine, fatto-formazione-2025-sotto-obiettivo, fatto-investimento-tunnel-confermato, fatto-listeria-canalina-linea3-al-riesame, fatto-mock-recall-marzo-2026, fatto-ore-formazione-crollate, fatto-politica-riconfermata-senza-modifiche, fatto-pre-verifica-simulata-prima-del-controllo, fatto-revisione-modulistica-ccp, fatto-riesame-straordinario-e-facolta-rsgq, fatto-risorse-adeguate-con-riserva, fatto-sei-nc-aperte-oltre-sessanta-giorni, fatto-sistema-adeguato-con-riserve, fatto-straordinari-oltre-limite-linea2, fatto-tarature-92-percento-al-riesame, fatto-test-rintracciabilita-audit-2h50, fatto-turnover-linea2-e-domeniche, questione-carrello-ricambi-dichiarato-rimosso, questione-cinquanta-o-cinquantadue-persone, questione-clausola-della-nc1-in-due-versioni, questione-cruscotto-e-obiettivi-non-si-mappano, questione-i-moduli-ccp-rivisti-prima-del-controllo, questione-mock-recall-due-ore-o-quattro, questione-nc-interne-registrate-su-mod-qa-31, questione-ore-formazione-due-valori-per-il-2025, questione-vendor-rating-2025-c-e-o-non-c-e, doc-azioni-deliberate-riesame-2026, doc-cruscotto-kpi-2026, doc-riesame-direzione-2026, kpi-costo-non-qualita-due-totali, kpi-indicatori-2025-consuntivo, kpi-obiettivi-2026-avanzamento, kpi-pareto-cause-nc-2026, kpi-reclami-2025, kpi-registro-reclami-2026, kpi-vendor-rating-2025, questione-due-esercitazioni-e-una-sola-ultima, questione-reclami-per-confezioni-o-per-pezzi, questione-riesame-trimestrale-haccp |
