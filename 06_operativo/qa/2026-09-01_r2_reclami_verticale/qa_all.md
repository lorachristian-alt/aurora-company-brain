...
- Data: 2026-09-01
- Perimetro: **lotto** (lotto `r2_reclami_verticale`) — **perimetro di manutenzione: 0 grezzi, 105 note** (E35)
...
> suite QA · perimetro manutenzione (0 grezzi, 105 note) · **0 ERRORI, 109 AVVISI** · esito **GIALLO**
...
*Escluse `workspace\` e `sources\` dai conteggi di qualità: **492** note.*
...
---
## qa_frontmatter (perimetro: lotto, 116 note)
...
| `fatto-blocco-cautelativo-lotti.md` |  | frontmatter | corpo di 327 parole: fra 301 e 350, si motiva o si spezza |
...
| `doc-verifiche-immediate-reclamo.md` |  | frontmatter | corpo di 311 parole: fra 301 e 350, si motiva o si spezza |
| `kpi-indicatori-2025-consuntivo.md` |  | frontmatter | corpo di 332 parole: fra 301 e 350, si motiva o si spezza |
| `kpi-mass-balance-l26130.md` |  | frontmatter | summary di 289 caratteri (tetto 250) |
...
| `kpi-registro-reclami-2026.md` |  | frontmatter | corpo di 347 parole: fra 301 e 350, si motiva o si spezza |
| `questione-un-richiamo-in-classe-2.md` |  | frontmatter | summary di 263 caratteri (tetto 250) |
| `sessione-r2-manutenzione-due-domini.md` |  | frontmatter | summary di 255 caratteri (tetto 250) |


## qa_link_integrity (perimetro: lotto, 510 note nel vault)
...
## qa_provenance (perimetro: lotto, 116 note)
...
## qa_copertura (perimetro: lotto, 116 note)
...
| `fatto-richiesta-relazione-48-ore.md` | atomica | risolto | 3 |
...
| `doc-classi-di-gravita-della-crisi.md` | atomica | risolto | 2 |
...
| `doc-flusso-della-crisi-sei-fasi.md` | atomica | risolto | 2 |
...
| `doc-modulistica-e-dossier-di-crisi.md` | atomica | risolto | 2 |
...
| `doc-verifiche-immediate-reclamo.md` | atomica | risolto | 3 |
...
| `fatto-due-segnalazioni-rendono-il-ritiro-non-rimandabile.md` | atomica | risolto | 3 |
...
| `fatto-le-48-ore-gia-in-procedura.md` | atomica | risolto | 1 |
...
| `fatto-procedura-applicata-al-caso-di-maggio.md` | atomica | risolto | 2 |
...
| `fatto-semilavorati-senza-identificazione-in-cella.md` | atomica | risolto | 2 |
...
| `kpi-registro-reclami-2026.md` | atomica | aperto | 4 |
...
| `questione-un-richiamo-in-classe-2.md` | conflitto | aperto | 3 |
| `sessione-r2-manutenzione-due-domini.md` | sessione | — | 0 |
