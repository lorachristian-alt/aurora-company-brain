...
- Data: 2026-08-23
- Perimetro: **lotto** (lotto `giudizio_t141_bis`) — **perimetro di manutenzione: 0 grezzi, 1 note** (E35)
...
> suite QA · perimetro manutenzione (0 grezzi, 1 note) · **0 ERRORI, 16 AVVISI** · esito **GIALLO**
...
---
## qa_frontmatter (perimetro: lotto, 12 note)
...
|---|---|---|---|
| `fatto-evidenze-audit-oltre-termine.md` |  | frontmatter | summary di 454 caratteri (tetto 250) |
...
## qa_copertura (perimetro: lotto, 12 note)
