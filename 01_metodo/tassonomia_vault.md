...
| `areas` | «responsabilità continue» | Le responsabilità che non finiscono mai: produzione & manutenzione, QA/QC, logistica, commerciale & marketing, R&D, amministrazione-finanza-controllo, HR. Il vocabolario macchina del campo `area` che raffina questi raggruppamenti (10 valori → 10 hub, tutti in areas, con tabella di corrispondenza) è definito in metodo_03 §2.2: la fonte è quella, qui non si duplica. |
