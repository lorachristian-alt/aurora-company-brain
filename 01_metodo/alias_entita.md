...
| `entita-ulss-9-scaligera` | «AZIENDA ULSS 9 SCALIGERA» · «Azienda ULSS 9 Scaligera» · «ULSS 9» · «AULSS 9» · **«ULSS»** e **«l'ULSS»** nelle mail interne · `SIAN` · «Servizio Igiene degli Alimenti e della Nutrizione» · PEC `protocollo.dip@pec.aulss9.veneto.it` · registrazione dello stabilimento `037/2019/SIAN` | preavviso di ispezione, verbale di ispezione |
| `entita-paola-segattini` | «dott.ssa Paola Segattini» · «Segattini» · `paola.segattini@aulss9.veneto.it` | preavviso di ispezione, §responsabile del procedimento |
...
| 2026-08-24 | S4 lotto 3F — il controllo pubblico ATS | Classe A: **`entita-ulss-9-scaligera`**, con le forme dell'atto e quelle delle mail interne — «ULSS», «l'ULSS» — e con `SIAN` e la registrazione `037/2019/SIAN`, che sono **identificativi dell'ente e dello stabilimento presso l'ente**, non varianti di nome; e `entita-paola-segattini`, il responsabile del procedimento. ⚠️ **Nessuna riga di classe B o C.** ⚠️ **E tre nomi propri NON sono entrati**: il Direttore dell'U.O. che firma il preavviso e i due tecnici della prevenzione che redigono il verbale compaiono **una volta sola ciascuno**, non hanno varianti da sciogliere, e stanno dentro la scheda dell'ente — **una scheda entità per ogni nome che compare una volta sarebbe sovra-atomizzazione** |
